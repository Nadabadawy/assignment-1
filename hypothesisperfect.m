...
U1=T{1:m_60,20:21};
U2=U.^2;
X=[ones(m_60,1) U U1 U.^2 U.^3 U.^4];
...
UU=T{m_60+1:m_60+m_20,4:19};
UU1=T{m_60+1:m_60+m_20,20:21};
UU2=UU.^2;
XX=[ones(m_20,1) UU UU1 UU.^2 UU.^3 UU.^4];
Theta1=Theta;
...
UUU=T{m_60+m_20+1:end,4:19};
UUU1=T{m_60+m_20+1:end,20:21};
UUU2=UUU.^2;
XXX=[ones(p,1) UUU UUU1 UUU.^2 UUU.^3 UUU.^4];
Theta2=Theta1;
